...
from level_specific.silo.details import dividingTiles, startTileName, excludeDoorReachPresets
from data.silo import tiles, guards, objects, pads, lone_pads, level_scale, sets, presets, activatable_objects
from level_specific.silo.group_names import *
import numpy as np
from lib.path_finding import rotACWS

def silo_specific(tilePlanes, currentTiles, plt, axs):
...
def main(plt, tiles, dividingTiles, startTileName, objects, level_scale, GROUP_NO, path):
    ...
    # Call specific code
    silo_specific(tilePlanes, currentTiles, plt, axs)
...
if __name__ == "__main__":
    main(plt, tiles, dividingTiles, startTileName, objects, level_scale, 0, "silo/silo_full")
