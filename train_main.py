...
from level_specific.train.details import dividingTiles, startTileName, excludeDoorReachPresets
from data.train import tiles, guards, objects, pads, lone_pads, level_scale, sets, presets, activatable_objects
from level_specific.train.group_names import *
import numpy as np
from lib.path_finding import rotACWS

def train_specific(tilePlanes, currentTiles, plt, axs):
...
def main(plt, tiles, dividingTiles, startTileName, objects, level_scale, GROUP_NO, path):
    ...
    # Call specific code
    train_specific(tilePlanes, currentTiles, plt, axs)
