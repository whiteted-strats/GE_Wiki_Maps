...
from level_specific.jungle.details import dividingTiles, startTileName, excludeDoorReachPresets
from data.jungle import tiles, guards, objects, pads, lone_pads, level_scale, sets, presets, activatable_objects
from level_specific.jungle.group_names import *
import numpy as np
from lib.path_finding import rotACWS

def jungle_specific(tilePlanes, currentTiles, plt, axs):
...
def main(plt, tiles, dividingTiles, startTileName, objects, level_scale, GROUP_NO, path):
    ...
    # Call specific code
    jungle_specific(tilePlanes, currentTiles, plt, axs)
...
if __name__ == "__main__":
    main(plt, tiles, dividingTiles, startTileName, objects, level_scale, 0, "jungle/jungle_full")
