...
from level_specific.cradle.details import dividingTiles, startTileName, excludeDoorReachPresets
from data.cradle import tiles, guards, objects, pads, lone_pads, level_scale, sets, presets, activatable_objects
from level_specific.cradle.group_names import *
import numpy as np
from lib.path_finding import rotACWS

def cradle_specific(tilePlanes, currentTiles, plt, axs):
...
def main(plt, tiles, dividingTiles, startTileName, objects, level_scale, GROUP_NO, path):
    ...
    # Call specific code
    cradle_specific(tilePlanes, currentTiles, plt, axs)
