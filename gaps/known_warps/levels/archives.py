...
KNOWN_WARPS = [
    ...
    KnownWarp(
        ...
        notes="Room 0x37, upstairs. A hairline: 0.00012 cm. There is a pane in the same place "
        "downstairs.",
    ),
    KnownWarp(
        ...
        notes="Room 0x2f. A hairline: 0.000015 cm. The closed door between the safe and the end.",
    ),
]
